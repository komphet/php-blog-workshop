...
$blogs = mysqli_query($conn, "SELECT blogs.id,username, title, content, blogs.created_at  FROM blogs JOIN users ON users.id = blogs.user_id ORDER BY blogs.id DESC;") or die(mysqli_error($conn));
?>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 m-b-3">
                    <div class="tm-content-box" style="height: 300px;">
                        <h4 class="tm-margin-b-20 tm-gold-text" style="width: 100%; height: 1.5em; overflow: hidden;">
                            <a href="/?page=show&id=<?php echo $row['id'] ?>">
                        ...
                        <a href="/?page=show&id=<?php echo $row['id'] ?>" class="tm-btn text-uppercase">Read More</a>
