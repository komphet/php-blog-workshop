...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/assets/488_classic/css/bootstrap.min.css">
        <!-- Bootstrap style -->
        <link rel="stylesheet" href="/assets/488_classic/css/templatemo-style.css?v=3">
        <!-- Templatemo style -->
        ...
        <!-- load JS files -->
        <script src="assets/488_classic/js/jquery-1.11.3.min.js"></script>
        <!-- jQuery (https://jquery.com/download/) -->
        <script src="https://www.atlasestateagents.co.uk/javascript/tether.min.js"></script>
        <!-- Tether for Bootstrap, http://stackoverflow.com/questions/34567939/how-to-fix-the-error-error-bootstrap-tooltips-require-tether-http-github-h -->
        <script src="assets/488_classic/js/bootstrap.min.js"></script>
